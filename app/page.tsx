    ...
    <>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 text-center">
        ...
        <div className="relative z-10">
          ...
          <AnimateIn delay={0.2}>
            <h1 className="font-display mb-6 text-[clamp(5rem,20vw,14rem)] leading-none tracking-widest text-white">
              ML.BLENDZ
            </h1>
          </AnimateIn>

          <AnimateIn delay={0.35}>
            <p className="mb-10 text-lg text-zinc-300 md:text-xl">
              Precision cuts. Real results.
            </p>
          </AnimateIn>
          ...
          <AnimateIn delay={0.45}>
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link
                href="/book"
                className="glow-gold rounded-full bg-gold px-10 py-4 text-base font-bold text-black transition-all hover:bg-gold-light hover:scale-105 active:scale-95"
              >
                Book a Cut
              </Link>
              <Link
                href="/services"
                className="rounded-full border border-zinc-600 px-10 py-4 text-base font-medium text-white transition-all hover:border-zinc-400 hover:bg-white/5"
              >
                See Prices
              </Link>
            </div>
      ...
      <section className="border-y border-zinc-800/50 bg-zinc-900/40 px-4 py-16">
        <div className="mx-auto grid max-w-4xl grid-cols-3 gap-8 text-center">
          {[
            ...
            { end: 30, prefix: "$", suffix: "", label: "starting price" },
          ].map((stat, i) => (
            <AnimateIn key={i} delay={i * 0.1}>
              <p className="font-display text-5xl tracking-widest text-gold md:text-6xl">
      ...
      <section className="py-20">
        ...
        <div className="flex snap-x snap-mandatory gap-3 overflow-x-auto px-4 pb-4 md:px-8 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {[
            ...
            <div
              key={i}
              className="aspect-[9/16] w-48 shrink-0 snap-start overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 transition-transform hover:scale-[1.03] md:w-56"
            >
              <video
                src={src}
                autoPlay
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-4xl">
            ...
            {[
              {
                price: "$30",
                title: "Haircut",
                desc: "Fade, taper, trim — clean finish every time.",
              },
              {
                price: "$70",
                title: "Highlights / Dye",
                desc: "Full color, highlights, bleaching included. Color consult too.",
              },
            ].map((s, i) => (
              <AnimateIn key={i} delay={i * 0.12}>
                <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 p-8 transition-all duration-300 hover:border-gold/40 hover:shadow-2xl hover:shadow-gold/10">
                  ...
                  <div className="relative">
                    <p className="font-display mb-1 text-6xl tracking-widest text-gold">
                      {s.price}
                    </p>
          ...
          <AnimateIn className="mt-8 text-center" delay={0.2}>
            <Link
              href="/services"
              className="text-sm font-medium text-gold transition-colors hover:text-gold-light"
            >
      ...
      <section className="relative overflow-hidden border-t border-zinc-800 bg-zinc-900 px-4 py-28">
        ...
        <AnimateIn className="relative mx-auto max-w-2xl text-center">
          <p className="font-display mb-3 text-[clamp(4rem,18vw,9rem)] leading-none tracking-widest text-white">
            5M+
          </p>
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
              ...
              className="rounded-full border border-zinc-700 px-7 py-3 text-sm font-medium text-white transition-all hover:border-zinc-400 hover:bg-white/5"
            >
              TikTok @ml.blendz._
            </a>
      ...
      <section className="px-4 py-32 text-center">
        <AnimateIn className="mx-auto max-w-xl">
          <h2 className="font-display mb-6 text-5xl tracking-widest text-white md:text-6xl">
            Ready to get a cut?
          </h2>
          <p className="mb-10 text-zinc-400">
            Send a booking request and I&apos;ll confirm via text or email.
          </p>
          <Link
            href="/book"
            className="glow-gold inline-block rounded-full bg-gold px-12 py-4 text-base font-bold text-black transition-all hover:bg-gold-light hover:scale-105 active:scale-95"
          >
            Book Now
          </Link>
        </AnimateIn>
