    ...
    <>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 text-center">
        ...
        <div className="relative z-10">
          <AnimateIn delay={0.1}>
            <p className="mb-5 text-xs font-semibold uppercase tracking-[0.35em] text-gold">Los Altos · Mountain View, CA</p>
          </AnimateIn>
          <AnimateIn delay={0.2}>
            <h1 className="font-display mb-6 text-[clamp(5rem,20vw,14rem)] leading-none tracking-widest text-white">ML.BLENDZ</h1>
          </AnimateIn>
          <AnimateIn delay={0.35}>
            <p className="mb-10 text-lg text-zinc-300 md:text-xl">Precision cuts. Real results.</p>
          </AnimateIn>
          <AnimateIn delay={0.45}>
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link href="/book" className="glow-gold rounded-full bg-gold px-10 py-4 text-base font-bold text-black transition-all hover:bg-gold-light hover:scale-105 active:scale-95">Book a Cut</Link>
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-4xl">
          <AnimateIn className="mb-12 text-center">
            <h2 className="font-display text-4xl tracking-widest text-white md:text-5xl">What I Offer</h2>
          </AnimateIn>
          <div className="grid gap-6 md:grid-cols-2">
            {[
              { price: "$30", title: "Haircut", desc: "Fade, taper, trim — clean finish every time." },
              { price: "$70", title: "Highlights / Dye", desc: "Full color, highlights, bleaching included. Color consult too." },
            ].map((s, i) => (
      ...
      <section className="px-4 py-32 text-center">
        <AnimateIn className="mx-auto max-w-xl">
          ...
          <Link href="/book" className="glow-gold inline-block rounded-full bg-gold px-12 py-4 text-base font-bold text-black transition-all hover:bg-gold-light hover:scale-105 active:scale-95">Book Now</Link>
        </AnimateIn>
      </section>
    </>
  );
